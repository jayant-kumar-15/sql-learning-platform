    ...
    "rdbms": {
        ...
        "lessons": [
            ...
            },
            {
                ...
                "practice": "Conceptual: Write an index definition for transactions.account_id.\n\nNote: This statement changes shared data or structure, so the practice editor is intentionally not enabled here (to keep the demo schema and data consistent for everyone). Study the syntax and example above, then reason through what it would return/change.",
                "type": "conceptual"
            },
            {
