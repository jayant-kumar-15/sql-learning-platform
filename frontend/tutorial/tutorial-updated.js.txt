...
(() => {
    ...
    function initializeMobileNavigation() {
        ...
        /*
         * MOBILE NAVIGATION SCROLL BEHAVIOR — TUTORIAL ONLY
         * ------------------------------------------------------------
         * When the mobile navigation is open, scrolling the page should
         * close the menu. This prevents the open navigation from moving
         * upward/downward together with the tutorial content.
         *
         * Desktop behavior is untouched because this only acts when the
         * mobile navigation currently has the "open" class.
         */
