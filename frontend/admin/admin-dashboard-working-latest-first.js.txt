...
(function () {
    ...
    function drawChart(rows, resetScroll) {
        ...
        if (resetScroll) {
            ...
            /*
             * Start at the newest/rightmost traffic.
             *
             * The chart remains chronological from left to right.
             * The user can scroll LEFT to reveal older days/weeks.
             *
             * Two animation frames are used because mobile Chrome can
             * report the old scrollWidth before the canvas/layout has
             * finished sizing.
             */
