...
(function () {
    ...
    function drawChart(rows, resetScroll = false) {
        ...
        /*
         * IMPORTANT:
         * The first viewport is the newest/rightmost part of the
         * timeline. Older days/weeks are revealed by scrolling LEFT.
         */
        if (resetScroll) {
            const scrollToLatest = function () {
                ...
                /* Force one final layout read for mobile Chrome. */
