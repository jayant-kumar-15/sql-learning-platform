...
(function () {
    ...
    async function loadAnalytics() {
        ...
        $("#liveVisitors").textContent = formatNumber(
            data.liveVisitors ?? data.live_visitors
        );
    ...
    function renderFeedback() {
        ...
        items.forEach(function (item) {
            ...
            statusRow.innerHTML = "<label>Status <select><option value=\"new\">New</option><option value=\"read\">Read</option><option value=\"resolved\">Resolved</option></select></label>";
            ...
            statusSelect.addEventListener("change", async function () {
                ...
                try {
                    ...
                    const unread = state.feedback.filter(x => x.status === "new").length;
                    $("#newFeedback").textContent = formatNumber(unread);
                } catch (error) {
                    console.error(error);
                    statusSelect.value = item.status || "new";
