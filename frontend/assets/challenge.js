 ...
 * SHARE CHALLENGE
 * ------------------------------------------------------------
 * The share control always uses the currently opened question.
 * The generated URL contains both question ID and difficulty so
 * duplicate IDs across Beginner/Intermediate/Expert can never
 * resolve to the wrong challenge.
 * ============================================================
 */
