...
- SQL tutorials (Beginner to Advanced)
- Healthcare database
- Banking database
- SQL playground
- User Sandbox
...
## SQL Playground Requirements

- Execute SQL queries
- Query history
- Query auto-suggestions (ON/OFF)
- Save queries
...
- Users can create up to 2 databases
- Maximum 10 tables per database
- Maximum 1000 records per table
